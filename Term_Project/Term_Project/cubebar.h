...
public:
    ...
    GLfloat cubeColors[96] = { // initialized as RGBA sollid color for each face, 96 elements
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  // v0,v1,v2,v3 (front)
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  // v0,v3,v4,v5 (right)
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  // v0,v5,v6,v1 (top)
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  // v1,v6,v7,v2 (left)
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  // v7,v4,v3,v2 (bottom)
        0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1,  0.8,0.8,0.8,1   // v4,v7,v6,v5 (back)
    };
    ...
    GLfloat cubeTexCoords[48] = { // 48 elements
        ...
        0.5, 0,   0.5, 0.5,   0, 0.5,   0, 0,               // v0,v5,v6,v1 (top)
    ...
    Cubebar(float sx, float sy, float sz) {
        scale2(sx, sy, sz);
        initBuffers();
    };
    
    Cubebar(float dx, float dy, float dz, float s) {
        scale(s);
        translate(dx, dy, dz);
        initBuffers();
    };
    
    Cubebar(float dx, float dy, float dz, float sx, float sy, float sz) {
        scale2(sx, sy, sz);
        translate(dx, dy, dz);
        initBuffers();
    };
