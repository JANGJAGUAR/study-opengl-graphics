...
bool flyingcamOn = false;
QuadPyra* quadpyra;                 // call pyramid class
glm::mat4 projection, view, model;

// for arcball
float arcballSpeed = 0.2f;
static Arcball camArcBall(SCR_WIDTH, SCR_HEIGHT, arcballSpeed, true, true);     // camera Arcball
...
void render() {
    ...
    if (!flyingcamOn){
        ...
        // pyramid
        model = glm::mat4(1.0f);
        model = model * camArcBall.createRotationMatrix();
